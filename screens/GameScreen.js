...
export default GameScreen = ({ route, navigation }) => {
  ...
  return (
    <GameContainer>
      ...
      />
      <GameArtContainer>
        <GameArt source={game.cover2} resizeMode='stretch' />
        <BackButton onPress={() => navigation.goBack()}>
          <Ionicons name='ios-close' size={48} color='#ffff' />
        </BackButton>
      </GameArtContainer>
      ...
      <GameBody showsVerticalScrollIndicator={false}>
        <ScreeShotsContainer>
...
const GameBody = styled.ScrollView`
  margin-bottom: 10px;
`;

const ScreeShotsContainer = styled.View`
  margin: 8px 0px;
`;
